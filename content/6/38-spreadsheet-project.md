...
2. Переіменуйте аркуш у: `Мій інвентар`.
...
2. Введіть назвит стовпців (**A1:C1**) : `Гра`, `Рік виходу`, `Рейтинг`.
3. Заповніть дані про **Minecraft** та **Roblox** (скористайтеся пошууком в Інтернеті).
