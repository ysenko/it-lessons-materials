...
| 🧠 Мікрокомп'ютер | «Мозок» — обробляє дані, приймає рішення | Micro:Bit, Arduino |
...
🧠 **Мікрокомп'ютер** — обробляє та вирішує
...
Виконує паркур і сальто — дивись самі!
...
🍇 **Хірург Da Vinci**
Зашиває виноградину — точність до 1 мм!
...
- Яку роль виконує **мікрокомп'ютер** у роботі робота?
