...
- 🍌 Побудуємо **«Бананову плантацію»** у Scratch, використовуючи вкладені цикли.
...
- **Внутрішній цикл** — виконується **повністю** на кожному «великому кроці» (наприклад, банани у рядку).
...
## 🍌 Завдання: «Бананова плантація»

**Підготовка:** відкрити Scratch, додати спрайт **«Банан»**, видалити спрайт «Кіт».
Додати розширення **«Олівець»** (кнопка «+» внизу ліворуч) → знайти блок **«штамп»**.

**Три кроки (продовжуємо один скрипт):**

1. 🍌 Намалювати **один рядок** бананів — внутрішній цикл
2. 🍌🍌 Додати **зовнішній цикл** → 4 рядки по 4 банани
...
> 💡 Запусти — побачиш **7 бананів** в один рядок!

</div>
<div class="image-center">

<!-- 📸 ЗНІМОК ЕКРАНУ: результат — 7 бананів в один рядок на сцені Scratch -->
...
<!-- 📸 ЗНІМОК ЕКРАНУ: результат — 4 рядки по 7 бананів на сцені Scratch -->
...
<!-- 📸 ЗНІМОК ЕКРАНУ: результат — 4 кольорові рядки бананів на сцені Scratch -->
...
❌ Забули **`задати x (-180)`** у зовнішньому — кожен рядок починається там, де закінчився попередній.
