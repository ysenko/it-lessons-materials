...
2. `очистити все`
3. `перемістити в x(-150) y(0)`
4. **`повторити (5) разів`**
   - `штамп`
   - `перемістити на (60) кроків`

> 💡 Запусти — побачиш **5 квіток** в один рядок!
...
1. Змінити позицію: `перемістити в x(-150) y(100)`
2. Обгорнути внутрішній цикл у **зовнішній**:
...
![w:300px](./assets/57/step2-grid.png)
...
![w:300px](./assets/57/step3-colors.png)
