...
- 📊 Які відеоформати існують і де вони застосовуються
...
### 🖥️ Екран монітора
Screen recording — запис того, що відбувається на екрані
...
- Ваше обличчя у кутку екрану
- Екран комп'ютера в основній частині
- Все це синхронізовано в одному файлі

**Коли це використовується**:

- Онлайн-уроки (з використанням OBS Studio у разі недоступності Google Vids)
...
### Запис презентації з вашою участю у Google Vids
...
2. 💻 Розкажіть, як розв'язати просту **задачу з програмування**
3. 🔍 Продемонструйте **цікавий факт про комп'ютери**
4. 📖 Поясніть, як використовувати **будь-яку програму** на комп'ютері
...
1. Опрацюйте матеріал підручника (с. 211-216).
2. Запишіть у зошит характеристики вашого відео: назву, розмір (МБ), роздільну здатність та тривалість.
