...
**Те, що ми вивчали**: аудіо — це звук, записаний у файл. Його можна захопити різними способами та зберегти в різних форматах.
...
## 📝 Під час практичної роботи запишіть

Запишіть у зошит про ваше відео:

- 📄 **Назва файлу**
- 💾 **Розмір файлу** (у МБ)
- 📐 **Розрішення запису** (наприклад, 1920×1080)
- ⏱️ **Тривалість видео** (у секундах)
...
Дослідіть:
- Які видеоформати підтримує **ваш мобільний телефон**?
- Знайдіть професійне ПЗ для обробки відео (наприклад, **OBS Studio**, **Camtasia**)
- Напишіть 2-3 речення про його можливості

---

## 💭 Питання для розмислення

Перед наступним уроком подумайте:

> Де в Інтернеті ви найчастіше дивитеся відео?
> Яким форматам вони відповідають?
