...
### 🎥 Комбінований запис
Одночасно екран + ваше зображення у камері
...
**Кодек**
Алгоритм, який стискає дані. Впливає на якість та розмір файлу
...
1. Відкрити Google Vids (<a href=https://vids.google.com target="_blank">https://vids.google.com</a>)
