...
Фільтр за значеннями (Київська область та м. Київ — один рядок у таблиці) + умова «Більше ніж» `10000000` на `finesPassengerTransport`.
...
**Гіпотеза 2** — не підтвердилася: у Київській області та м. Києві — лише 4 929 490 грн.
