...
> 📸 Рекомендоване зображення: діаграма рядка `"Програмування"` з позначеними індексами (0…12 та -13…-1).
> Збережіть як: `content/7/assets/assessments/programming-diagnostic/programming-diagnostic-img-1.png`
...
**13.** Програма викликає помилку `TypeError` при спробі виконати `18 - age` *(див. зображення нижче)*. Зіставте рядок виправленого коду з його призначенням (3 пари — 3 бали).

> 📸 Рекомендоване зображення: знімок екрану Thonny з повідомленням `TypeError: unsupported operand type(s) for -: 'int' and 'str'`.
> Збережіть як: `content/7/assets/assessments/programming-diagnostic/programming-diagnostic-img-2.png`

![Повідомлення TypeError у Thonny](../assets/assessments/programming-diagnostic/programming-diagnostic-img-2.png)

| Рядок коду | Призначення |
|---|---|
| `age = int(input("Скільки вам років? "))` | Об'єднує рядки з числом у одне речення |
| `years_to_18 = 18 - age` | Перетворює введений рядок на ціле число |
| `"До повноліття: " + str(years_to_18) + " років"` | Обчислює різницю між двома цілими числами |
...
> 📸 Рекомендоване зображення: знімок екрану Thonny з кодом програми та виводом (наприклад, для N=4 виводить `Сума: 4` замість `Сума: 10`).
> Збережіть як: `content/7/assets/assessments/programming-diagnostic/programming-diagnostic-img-3.png`
...
**18.** Зіставте функцію модуля `random` з її призначенням (4 пари — 4 бали):

| Функція | Призначення |
|---|---|
| `random.randint(1, 10)` | Обирає один випадковий елемент із рядка або списку |
| `random.choice("abc")` | Генерує випадкове дійсне число від 0.0 до 1.0 |
| `random.random()` | Перемішує елементи списку у випадковому порядку |
| `random.shuffle([1,2,3])` | Генерує випадкове ціле число від 1 до 10 |
