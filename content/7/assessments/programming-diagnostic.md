...
**19.** Розглянь програму перевірки пароля *(див. зображення нижче)*. Зіставте пароль із тим, що виведе програма (3 пари — 3 бали).

![Програма перевірки надійності пароля у Thonny](../assets/assessments/programming-diagnostic/programming-diagnostic-img-4.png)

| Пароль | Що виведе програма |
|---|---|
| `abc` | `"Пароль надійний ✅"` |
| `FghRtyV1` | `"Пароль занадто короткий ❌"` |
| `Vfr5Bgt6Nhy!` | `"Пароль прийнятний, але краще зробити довше"` |
