...
**3.** Доповни програму, щоб вона правильно зберегла і вивела дані про учня. Заповни 3 пропуски (3 бали).

```python
my_name = "Оля"
my_age = ___          # вік — ціле число 13
is_student = ___      # логічне значення True
...
**16.** Яка функція модуля `random` повертає випадковий елемент із рядка або списку?
