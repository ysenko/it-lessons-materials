...
**19.** Розглянь програму перевірки пароля *(див. зображення нижче)*. Зіставте умову з реакцією програми (3 пари — 3 бали).

> 📸 Потрібне зображення: знімок екрану Thonny з кодом програми `q19-demo.py`.
> Збережіть як: `content/7/assets/assessments/programming-diagnostic/programming-diagnostic-img-4.png`

![Програма перевірки надійності пароля у Thonny](../assets/assessments/programming-diagnostic/programming-diagnostic-img-4.png)

| Умова | Реакція програми |
|---|---|
| `length >= 12` | `"Пароль занадто короткий ❌"` |
| `length >= 8` (elif) | `"Пароль надійний ✅"` |
